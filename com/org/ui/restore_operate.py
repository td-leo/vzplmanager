...
class Ui_RestoreOperateForm(object):
    ...
    def retranslateUi(self, RestoreOperateForm):
        ...
        self.pushButton.setText(_translate("RestoreOperateForm", "PushButton"))
        self.pushButton_2.setText(_translate("RestoreOperateForm", "PushButton"))
        self.pushButton_3.setText(_translate("RestoreOperateForm", "PushButton"))
