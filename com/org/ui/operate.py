...
class Ui_OperateForm(object):
    ...
    def retranslateUi(self, OperateForm):
        ...
        self.pushButton.setText(_translate("OperateForm", "PushButton"))
        self.pushButton_2.setText(_translate("OperateForm", "PushButton"))
        self.pushButton_3.setText(_translate("OperateForm", "PushButton"))
