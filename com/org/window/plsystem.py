...
class Ui_SystemForm(object):
    def setupUi(self, SystemForm):
        ...
        SystemForm.resize(721, 509)
        self.tabWidget = QtWidgets.QTabWidget(SystemForm)
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 721, 501))
        ...
        self.tableWidget_2.setGeometry(QtCore.QRect(10, 80, 701, 361))
        ...
        self.tableWidget_5.setGeometry(QtCore.QRect(10, 100, 701, 361))
